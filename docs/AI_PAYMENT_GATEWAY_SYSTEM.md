...
- Phase 1: Google Pay cards/tokenized payments, Google Pay UPI collect, Paytm, UPI, Cards
...
## 7) Google Pay UPI integration checklist
- Validate VPA format and merchant collect limits.
- Create collect requests with clear expiry and customer consent text.
- Poll webhook/status for success, pending, failed states.
- Reconcile collect ID with ledger and settlement reports.
- Add risk rules for VPA velocity, device mismatch, and high-risk retries.
