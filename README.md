...
- accepts **Google Pay**, **Google Pay UPI**, and **Paytm**,
...
python -m app.cli create-intent --amount 499 --currency INR --customer-id cust_22 --payment-method google_pay_upi --upi-vpa alice@okhdfcbank
python -m app.cli gpay-upi-collect --amount 499 --currency INR --customer-id cust_22 --upi-vpa alice@okhdfcbank
python -m app.cli gpay-upi-status --collect-id gupi_1234567890abcd
...
- `POST /v1/google-pay-upi/collect`
- `GET /v1/google-pay-upi/status/{collect_id}`
...
## Google Pay UPI collect example
